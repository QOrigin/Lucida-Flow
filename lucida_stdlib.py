...
from lib.gui import NATIVE_GUI_MODULE
...
from lib.fs import NATIVE_FS_MODULE
from lib.math3d import NATIVE_MATH3D_MODULE, register_semantics as register_math3d_semantics
from lib.qbit import NATIVE_QBIT_MODULE, register_semantics as register_qbit_semantics
from lib.gui import NATIVE_GUI_MODULE, register_semantics as register_gui_semantics
from lib.time import NATIVE_TIME_MODULE, register_semantics as register_time_semantics
...
NATIVE_MODULES = {
    ...
    "math3d": NATIVE_MATH3D_MODULE,
    "qbit": NATIVE_QBIT_MODULE,
    "fs": NATIVE_FS_MODULE,
    "math": NATIVE_MATH_MODULE,
    "media": NATIVE_MEDIA_MODULE,
    "gui": NATIVE_GUI_MODULE,
    "time": NATIVE_TIME_MODULE
}
...
NATIVE_MODULES_SEMANTICS = {
    ...
    "gui": register_gui_semantics(),
    "math3d": register_math3d_semantics(),
    "qbit": register_qbit_semantics(),
    "time": register_time_semantics()
}
